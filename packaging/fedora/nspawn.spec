...
- The overlay module loads under SELinux on a freshly booted host.

* Fri Sep 25 2026 Eduard Tolosa <tolosaeduard@gmail.com> - 1.4.0-1
- A machine in another machine's network with --network container:NAME.
- A group with --user, as docker's USER:GROUP.
- Pulls fetch three blobs at a time.
...
* Thu Sep 24 2026 Eduard Tolosa <tolosaeduard@gmail.com> - 1.2.0-1
- run stays attached like docker run (-d for the background, --rm, -i, -t);
  user-defined networks; events, stats, update and kill.
...
* Wed Sep 23 2026 Eduard Tolosa <tolosaeduard@gmail.com> - 1.1.0-1
- Restart policies, resource limits, inspect and JSON output, labels, cp, rm
  and named volume management.
